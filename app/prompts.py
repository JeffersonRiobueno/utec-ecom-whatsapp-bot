...
5. Si el mensaje contiene un correo o un número de celular, es *"pedido"*.
6. Si menciona "quiero", "me interesa", "estoy buscando", "me gustaría", "tienen", "venden", "busco", "necesito" seguido de un nombre de producto o categoría (ej. zapatos, pulseras, collares, aretes, ropa, accesorios), es *"consulta_producto"*.
7. Si el mensaje es una PREGUNTA GENÉRICA como:
   - "¿Cómo saber mi talla?"
